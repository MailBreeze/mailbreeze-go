...
func (r *ContactsResource) Create(ctx context.Context, params *CreateContactParams) (*Contact, error) {
	var contact Contact
	if err := r.client.Post(ctx, fmt.Sprintf("/lists/%s/contacts", r.listID), params, &contact); err != nil {
		return nil, err
	}
	return &contact, nil
}
...
func (r *ContactsResource) List(ctx context.Context, params *ListContactsParams) (*ContactList, error) {
	...
	if err := r.client.Get(ctx, fmt.Sprintf("/lists/%s/contacts", r.listID), query, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (r *ContactsResource) Get(ctx context.Context, contactID string) (*Contact, error) {
	var contact Contact
	if err := r.client.Get(ctx, fmt.Sprintf("/lists/%s/contacts/%s", r.listID, contactID), nil, &contact); err != nil {
		return nil, err
	}
	return &contact, nil
}
...
func (r *ContactsResource) Update(ctx context.Context, contactID string, params *UpdateContactParams) (*Contact, error) {
	var contact Contact
	if err := r.client.Patch(ctx, fmt.Sprintf("/lists/%s/contacts/%s", r.listID, contactID), params, &contact); err != nil {
		return nil, err
	}
	return &contact, nil
}
...
func (r *ContactsResource) Delete(ctx context.Context, contactID string) error {
	return r.client.Delete(ctx, fmt.Sprintf("/lists/%s/contacts/%s", r.listID, contactID))
}

// Suppress suppresses a contact (adds to suppression list).
func (r *ContactsResource) Suppress(ctx context.Context, contactID string) (*Contact, error) {
	var contact Contact
	if err := r.client.Post(ctx, fmt.Sprintf("/lists/%s/contacts/%s/suppress", r.listID, contactID), nil, &contact); err != nil {
		return nil, err
	}
	return &contact, nil
}
